...
- (void)setDataSource:(id<YHExcelViewDataSource>)dataSource {
    ...
    /**
     * 如果不设置estimatedRowHeight estimatedSectionFooterHeight estimatedSectionHeaderHeight
     * self.tableView.contentSize会计算不准
     */
    ...
    [_tableView registerClass:[YHExcelViewCell class] forCellReuseIdentifier:@"YHExcelViewCell"];
