...
- (BOOL)excelTitleView:(YHExcelTitleView *)titleView titleAdjustsFontSizeToFitWidthAtIndex:(NSInteger)index;
@end
...
@property (nonatomic ,assign) BOOL adjustsFontSizeToFitWidth; //default NO
