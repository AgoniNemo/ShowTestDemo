...
- (void)createItemWithIndex:(NSInteger)index {
    ...
    if (_dataSource != nil && [_dataSource respondsToSelector:@selector(excelTitleView:titleAdjustsFontSizeToFitWidthAtIndex:)]) {
        label.adjustsFontSizeToFitWidth = [_dataSource excelTitleView:self titleAdjustsFontSizeToFitWidthAtIndex:index];
    }else{
...
//        label.layer.borderColor = [UIColor colorWithRed:187/255.0f green:187/255.0f blue:187/255.0f alpha:1].CGColor;
